...
void generateData() {
  users = [
    User(
      ...
      assets: 'assets/images/user/img1.jpg',
    ),
    User(
      id: 2,
      nickname: 'Mauri38',
      password: 'mauri',
      gender: Gender.MALE,
      assets: 'assets/images/user/img2.jpg',
    ),
    User(
      id: 3,
      nickname: 'Steven2019',
      password: 'steven',
      gender: Gender.MALE,
      assets: 'assets/images/user/img3.jpg',
    ),
    User(
      id: 4,
      ...
      password: 'leopoldo',
      gender: Gender.MALE,
      assets: 'assets/images/user/img4.jpg',
    ),
    User(
      id: 6,
      nickname: 'Julia38',
      password: 'julia',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img6.jpg',
    ),
    User(
      id: 7,
      nickname: 'KatyPerez',
      password: 'katy',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img7.jpg',
    ),
    User(
      id: 8,
      ...
      password: 'enrry',
      gender: Gender.MALE,
      assets: 'assets/images/user/img8.jpg',
    ),
    User(
      id: 9,
      ...
      password: 'rosa',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img9.jpg',
    ),
    User(
      id: 10,
      ...
      password: 'marlon',
      gender: Gender.MALE,
      assets: 'assets/images/user/img10.jpg',
    ),
    User(
      id: 11,
      ...
      password: 'esperanza',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img11.jpg',
    ),
    User(
      id: 12,
      nickname: 'Gumercinda',
      password: 'gumercinda',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img12.jpg',
    ),
    User(
      id: 13,
      ...
      password: 'enriqueta',
      gender: Gender.MALE,
      assets: 'assets/images/user/img13.jpg',
    ),
    User(
      id: 14,
      nickname: 'LuzAlf',
      password: 'luz',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img14.jpg',
    ),
    User(
      id: 15,
      ...
      password: 'soraya',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img15.jpg',
    ),
    User(
      id: 16,
      nickname: 'SuyinHu',
      password: 'suyin',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img16.jpg',
    ),
    User(
      id: 17,
      ...
      password: 'estela',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img17.jpg',
    ),
    User(
      id: 18,
      nickname: 'LuisaMagañ',
      password: 'luisa',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img18.jpg',
    ),
    User(
      id: 19,
      nickname: 'Yakinawa',
      password: 'yakinawa',
      gender: Gender.FEMALE,
      assets: 'assets/images/user/img19.jpg',
    ),
    User(
      id: 20,
      ...
      password: 'luis',
      gender: Gender.MALE,
      assets: 'assets/images/user/img20.jpg',
    ),
    User(
      id: 21,
      nickname: 'Jorge',
  ...
  recipes = <Recipe>[
    Recipe(
      ...
      user: users[0],
      assets: 'assets/images/dish/pollo-empanizado.jpg',
    ),
    Recipe(
      ...
      user: users[6],
      assets: 'assets/images/dish/sopa-de-tortillas.jpg',
    ),
    Recipe(
      ...
      user: users[3],
      assets: 'assets/images/dish/pupusas-de-pollo.jpg',
    ),
    Recipe(
      ...
      user: users[7],
      assets: 'assets/images/dish/hacer-coctel-de-camaron.jpg',
    ),
    Recipe(
      ...
      user: users[6],
      assets: 'assets/images/dish/escabeche-salvadoreno.jpg',
    ),
    Recipe(
      ...
      user: users[9],
      assets: 'assets/images/dish/empanadas-salvadorenas.jpg',
    ),
    Recipe(
      name: 'Sopa de tortillas',
      description:
      ...
      user: users[9],
      assets: 'assets/images/dish/empanadas-argentinas.jpg',
    ),
  ];
}
